...
import 'package:avtonalivator/domain/connection/connector.dart' as _i10;
import 'package:avtonalivator/domain/connection/device_methods.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i10.Connector>(() => _i10.FbsConnector(gh<_i5.FbsAdapter>()));
    gh.factory<_i11.DataSource>(() => _i11.DataSource(gh<_i4.Dio>()));
    gh.factory<_i12.DeviceMethods>(
        () => _i12.FbsDeviceMethods(gh<_i5.FbsAdapter>()));
    gh.factory<_i13.ScanCubit>(() => _i13.ScanCubit(
          gh<_i7.SettingsBox>(),
          gh<_i10.Connector>(),
        ));
    gh.factory<_i14.TuningProvider>(() => _i14.TuningProvider(
          gh<_i12.DeviceMethods>(),
          gh<_i7.SettingsBox>(),
        ));
    gh.singleton<_i15.CocktailsRepository>(
        _i15.CocktailsRepository(gh<_i11.DataSource>()));
    gh.singleton<_i16.ConfigRepository>(
        _i16.ConfigRepository(gh<_i11.DataSource>()));
    gh.factory<_i17.CocktailsProvider>(
        () => _i17.CocktailsProvider(gh<_i15.CocktailsRepository>()));
    return this;
  }
}

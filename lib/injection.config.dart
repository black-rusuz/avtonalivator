...
import 'package:avtonalivator/domain/connector.dart' as _i12;
import 'package:avtonalivator/domain/repository/cocktails_repository.dart'
    as _i15;
import 'package:avtonalivator/domain/repository/config_repository.dart' as _i16;
...
import 'package:avtonalivator/presentation/pages/scan/cubit/scan_cubit.dart'
    as _i14;
import 'package:avtonalivator/presentation/provider/connection.dart' as _i17;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i10.TuningBloc>(() => _i10.TuningBloc(gh<_i7.SettingsBox>()));
    gh.factory<_i11.TuningProvider>(
        () => _i11.TuningProvider(gh<_i7.SettingsBox>()));
    ...
    gh.singleton<_i15.CocktailsRepository>(
        _i15.CocktailsRepository(gh<_i13.DataSource>()));
    gh.singleton<_i16.ConfigRepository>(
        _i16.ConfigRepository(gh<_i13.DataSource>()));
    gh.factory<_i17.ConnectionProvider>(
        () => _i17.ConnectionProvider(gh<_i12.Connector>()));

...
import 'package:avtonalivator/data/data_source.dart' as _i9;
import 'package:avtonalivator/domain/repository/cocktails_repository.dart'
    as _i11;
import 'package:avtonalivator/domain/repository/config_repository.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.DataSource>(() => _i9.DataSource(gh<_i4.Dio>()));
    gh.factory<_i10.ScanCubit>(() => _i10.ScanCubit(
          gh<_i6.SettingsBox>(),
          gh<_i3.Connector>(),
        ));
    gh.singleton<_i11.CocktailsRepository>(
        _i11.CocktailsRepository(gh<_i9.DataSource>()));
    gh.singleton<_i12.ConfigRepository>(
        _i12.ConfigRepository(gh<_i9.DataSource>()));
    gh.factory<_i13.TuningBloc>(
        () => _i13.TuningBloc(gh<_i12.ConfigRepository>()));
    gh.factory<_i14.CocktailsProvider>(
        () => _i14.CocktailsProvider(gh<_i11.CocktailsRepository>()));
    return this;
  }
}
